...
<body>
<div class="main-container" data-departmentid="${requestScope.departmentid}" data-name="${requestScope.name}">
    ...
    <div class="row" >
        <div class="offset-3 col-3">
            <div class="add-form">
                <form  id="add" class="addform" action='' method="post">
                    ...
                    <button type="submit" disabled class="command">
                        Create Employee
                    </button>
                    <br>
                    <div class="row"><div style="text-align: center"><p>Department id : ${requestScope.departmentid} , name : ${requestScope.name} </p></div></div>
